...
|           └── to_dotfiles/                    # Utilidades para gestionar dotfiles
|               ├── main.sh                     # Script principal de utilidades de dotfiles
|               └── to_dotfiles                 # Script para mover archivos a la carpeta de dotfiles
├── .devcontainer/                              # Configuración del contenedor de desarrollo
|   ├── devcontainer.json                       # Archivo de configuración del contenedor de desarrollo
|   ├── Dockerfile                              # Dockerfile para construir el contenedor de desarrollo
|   └── README.md                               # Archivo README con información sobre el contenedor de desarrollo
└── .vscode/                                    # Configuración de Visual Studio Code
    └── launch.json                             # Archivo de configuración de lanzamiento de VS Code
```
