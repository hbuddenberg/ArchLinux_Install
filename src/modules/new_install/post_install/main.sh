...
function run_additional_scripts() {
    ...
    sudo sh /tmp/ArchLinux_Install/src/modules/new_install/date_time_zone/main.sh

    gum style --foreground 10 "Ejecutando script de actualización de Pacman..."
    sudo sh /tmp/ArchLinux_Install/src/modules/new_install/pacman_update/main.sh
